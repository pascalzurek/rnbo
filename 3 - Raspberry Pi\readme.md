Dieser Patch kann genutzt werden, um einen Raspberry Pi zu starten. Das Setup entnimmt man [der PDF in ../docs](https://github.com/pascalzurek/rnbo/docs/RNBO-Zusammenfassung%202023-10.pdf).
